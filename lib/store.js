...
function requireSupabaseInProduction() {
  if (isServerlessRuntime() && !isSupabaseEnabled()) {
    throw new Error(
      'Supabase is required in production. Set SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY, and SUPABASE_ANON_KEY in your deployment environment.'
    );
  }
}
